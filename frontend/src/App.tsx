  ...
  return (
    <>
      <div className="flex h-screen theme-bg-primary overflow-hidden theme-text-primary">
        ...
        >
          <div
            className={`h-full backdrop-blur-xl bg-[var(--bg-sidebar)]/90 rounded-2xl border-0 overflow-hidden transition-all duration-300 ease-in-out ${sidebarWidth} shadow-[0_4px_20px_rgba(0,0,0,0.3),0_8px_32px_rgba(0,0,0,0.2)]`}
          >
            <Sidebar
