...
import { MessageSquare, AlertCircle, RefreshCw, ArrowDown } from 'lucide-react';
    ...
    <div className="flex-1 flex flex-col bg-slate-900 min-h-0 relative">
        ...
        <div className="h-full">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center h-full px-8">
              <div className="w-24 h-24 mb-6 rounded-full bg-gradient-to-br from-primary-500/20 to-slate-700/20 flex items-center justify-center">
      ...
      {showScrollButton && messages.length > 0 && (
        <button
          ...
          className="absolute bottom-4 right-4 p-3 bg-slate-700 hover:bg-slate-600 rounded-full shadow-lg transition-all hover:scale-110"
          title="滚动到底部"
        >
