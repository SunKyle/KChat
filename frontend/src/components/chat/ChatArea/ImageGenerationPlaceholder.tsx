    ...
    <div className='flex flex-col items-start py-2'>
      <div className='relative w-full max-w-[280px] aspect-square rounded-xl overflow-hidden border border-[var(--border-primary)] bg-[var(--bg-card)] shadow-sm'>
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(115deg, transparent 35%, rgba(210,180,140,0.06) 42%, rgba(210,180,140,0.10) 48%, rgba(210,180,140,0.06) 54%, transparent 60%)',
          }}
        />
        ...
        <div className='absolute inset-0 flex flex-col items-center justify-center gap-3.5'>
          ...
          <span className='text-[13px] font-medium tracking-[0.02em] text-[var(--text-secondary)]'>
            正在生成图片...
          </span>
        </div>
      </div>
