  ...
  return (
    <div className='flex-1 flex flex-col overflow-hidden'>
      ...
      <div className='flex-1 overflow-y-auto p-4'>
        <h2 className='text-base font-semibold text-[var(--text-primary)] leading-snug mb-4'>
          {note.title}
        </h2>
        ...
        <div className='text-sm leading-[1.75] break-words'>
    ...
    <div className='flex-1 flex flex-col overflow-hidden'>
      ...
      <div className='flex-1 overflow-y-auto p-4'>
        <div className='flex items-start gap-3 mb-4'>
          ...
          <h2
            className={`text-base font-semibold leading-snug ${todo.status === 'completed' ? 'text-[var(--text-muted)] line-through' : 'text-[var(--text-primary)]'}`}
          >
            {todo.title}
          </h2>
        </div>
        ...
        {todo.description && (
          <div className='text-sm text-[var(--text-secondary)] leading-[1.75] whitespace-pre-wrap break-words'>
            {todo.description}
          </div>
        )}
      </div>
